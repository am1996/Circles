...
export const UserSchema = z.object({
    ...
    password: z.string().min(8, { message: "Password must be at least 8 characeters long." }).refine(hasUppercaseChar, { message: "Password must contain at least one uppercase character" })
